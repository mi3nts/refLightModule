# -*- coding: utf-8 -*-
 ...
 class OceanDirectError(Exception):
     ...
     def __init__(self, errorCode: int, errorMsg: str):
         ...
         self._error_code_error_code = errorCode
         self._error_msg_error_msg  = errorMsg
  
     def get_error_details(self) -> tuple[int, str]:
         return (self._error_code_error_code, self._error_msg_error_msg)
  
 class OceanDirectAPI:
     
     class __OceanDirectSingleton:
         def __init__(self):
             self.oceandirectoceandirect = cdll.LoadLibrary(oceandirect_dll)
             self.oceandirectoceandirect.odapi_initialize()
             self.open_devicesopen_devices = dict()
             self.num_devicesnum_devices  = 0
             self.usb_devicesusb_devices  = 0
         ...
         def __del__(self):
             ...
             """
             try:
                 self.close_all_devicesclose_all_devices()
                 self.shutdownshutdown()
         ...
         def close_all_devices(self) -> None:
             ...
             """
             for dev in self.open_devicesopen_devices:
                 self.open_devicesopen_devices[dev].close_device()
         
         def shutdown(self) -> None:
             """
             Release any remaining used resources before shutting down the program.
             """
             self.oceandirectoceandirect.odapi_shutdown()
     ...
     def __getattr__(self, name):
         return getattr(self.instanceinstance, name)
 ...
 #        return errstr_cp.value.decode()
     ...
     def add_network_device(self, ipAddressStr: str, deviceTypeStr: str) -> None:
         ...
         the device exist and configured properly. Note that this should only be done by one thread at a time.
         ...
         if not ipAddressStr or not deviceTypeStr:
             error_msg = self.decode_errordecode_error(15, "add_network_device")
         ...
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "add_network_device")
     ...
     def find_devices(self) -> int:
         ...
         only be done by one thread at a time.
         @return Number of devices found.
         @see open_device()
         """
  
         try:
             self.tcpip_devicestcpip_devices = self.oceandirect.odapi_detect_network_devices()
         except Exception as e:
             exe_msg = traceback.format_exc()
             sdk_data_json = json.dumps(exe_msg)
             logger.error(sdk_data_json)
         ...
         try:
             self.usb_devicesusb_devices = self.oceandirect.odapi_probe_devices()
         except Exception as e:
             exe_msg = traceback.format_exc()
             sdk_data_json = json.dumps(exe_msg)
             logger.error(sdk_data_json)
     ...
     def find_usb_devices(self) -> int:
         ...
         this should only be done by one thread at a time.
         @return Number of devices found.
         @see open_device()
         """
         ...
         try:
             ...
             sdk_data_json = json.dumps(exe_msg)
             logger.error(sdk_data_json)
         return self.usb_devicesusb_devices
     ...
     def get_number_devices(self) -> int:
         ...
         try:
             self.num_devicesnum_devices = self.oceandirect.odapi_get_number_of_device_ids()
         except Exception as e:
             exe_msg = traceback.format_exc()
             sdk_data_json = json.dumps(exe_msg)
             logger.error(sdk_data_json)   
     
         return self.num_devicesnum_devices
     ...
     def get_device_ids(self) -> list[int]:
         ...
         num_ids = self.get_number_devicesget_number_devices()
         ids_cp = (c_long * num_ids)()
         err_cp = (c_long * 1)()
         n      = self.oceandirect.odapi_get_device_ids(ids_cp, err_cp)
  
         if n > 0:
             self.device_idsdevice_ids = list(ids_cp)
         else:
             self.device_idsdevice_ids =list()
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_device_ids")
             raise OceanDirectError(err_cp[0], error_msg)
  
         return self.device_idsdevice_ids
     ...
     def get_network_device_ids(self) -> list[int]:
         ...
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_network_device_ids")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def from_serial_number(self, serial_num: str) -> 'Spectrometer':
         ...
         devids = self.get_device_idsget_device_ids()
         dev    = None
  
         if len(devids) > 0:
             for dev_id in devids:
                 dev = self.open_deviceopen_device(dev_id)
                 od_status = dev.status 
                 sn = self.get_serial_numberget_serial_number(dev_id)
                 if sn == serial_num:
                     break
                 if (od_status == 'closed'):
                     self.close_deviceclose_device(dev_id)
         return dev
     ...
     def add_rs232_device(self, device_type: str, bus_path: str, baud: int) -> None:
         ...
         if added != 0:
             error_msg = self.decode_errordecode_error(added, "add_rs232_device")
     ...
     def get_serial_number(self, dev_id: int) -> str:
         ...
         if serial_number is None:
             ...
             if err_cp[0] != 0:
                 error_msg = self.decode_errordecode_error(err_cp[0], "get_serial_number")
                 raise OceanDirectError(err_cp[0], error_msg)
 ...
 class Spectrometer():
     ...
     def __init__(self, dev_id: int, oceandirect):
         self.device_iddevice_id = dev_id
         self.serial_numberserial_number = None
         self.modelmodel = None
         self.model_namemodel_name = None
         self.integration_timeintegration_time = None
         self.integration_minintegration_min = None
         self.integration_maxintegration_max = None
         self.pixel_count_formattedpixel_count_formatted = 0
         self.num_electric_dark_pixelsnum_electric_dark_pixels = None
         self.electric_dark_pixelselectric_dark_pixels = list()
         self.statusstatus = 'closed'
         self.wavelengthswavelengths = None
         self.oceandirectoceandirect = oceandirect
         self.AdvancedAdvancedAdvanced = self.AdvancedAdvancedAdvanced(device = self)
         self.apply_nonlinearityapply_nonlinearity = True
         self.scans_to_avgscans_to_avg = 1
         self.boxcar_hwboxcar_hw = False
         self.__nlflag__nlflag = c_ubyte(1)
     ...
     def get_serial_number(self) -> str:
         ...
         serial_cp = create_string_buffer(b'\000'*32)
         err_cp    = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_get_serial_number(self.device_iddevice_id, err_cp, serial_cp, 32)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_serial_number")
             raise OceanDirectError(err_cp[0], error_msg)
     
         self.serial_numberserial_number = serial_cp.value.decode()
         return self.serial_numberserial_number
     ...
     def get_device_type(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_get_device_type(self.device_iddevice_id, err_cp, device_type, 32)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_device_type")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_model(self) -> str:
         ...
         err_cp   = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_get_device_name(self.device_iddevice_id, err_cp, model_cp, 32)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_model")
             raise OceanDirectError(err_cp[0], error_msg)
         
         self.model_namemodel_name = model_cp.value.decode()
         return self.model_namemodel_name
     ...
     def decode_error(self, errno: int, caller: str) -> str:
         ...
         error_str_len = self.oceandirectoceandirect.odapi_get_error_string_length(errno)
         errstr_cp = create_string_buffer(b'\000'*error_str_len)
         self.oceandirectoceandirect.odapi_get_error_string(errno, errstr_cp, error_str_len)
     ...
     def open_device(self) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_open_device(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             #logger.error("open_device %s" % self.decode_error(err_cp[0], "open_device"))
             error_msg = self.decode_errordecode_error(err_cp[0],"open_device")
             raise OceanDirectError(err_cp[0], error_msg)
         else:
             self.statusstatus = 'open'
             err_cp = (c_long * 1)(0)
             self.pixel_count_formattedpixel_count_formatted = self.oceandirectoceandirect.odapi_get_formatted_spectrum_length(self.device_iddevice_id, err_cp)
             if err_cp[0] != 0:
                 error_msg = self.decode_errordecode_error(err_cp[0], "get_formatted_spectrum_length")
                 raise OceanDirectError(err_cp[0], error_msg)
             if self.serial_numberserial_number is None:
                 self.serial_numberserial_number = self.get_serial_numberget_serial_number()
             self.get_wavelengthsget_wavelengths()
     ...
     def close_device(self) -> None:
         ...
         err_cp = (c_long * 1)(0)
         if self.statusstatus == 'open':
             self.oceandirectoceandirect.odapi_close_device(self.device_iddevice_id, err_cp)
             if err_cp[0] != 0:
                 error_msg = self.decode_errordecode_error(err_cp[0],"close_device")
                 raise OceanDirectError(err_cp[0], error_msg)
         self.statusstatus = 'closed'
     ...
     def use_nonlinearity(self, nonlinearity_flag: bool) -> None:
         ...
         self.apply_nonlinearityapply_nonlinearity = nonlinearity_flag
         if nonlinearity_flag:
             self.__nlflag__nlflag = c_ubyte(1)
         else:
             self.__nlflag__nlflag = c_ubyte(0)
     ...
     def set_scans_to_average(self, newScanToAverage: int) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_set_scans_to_average(self.device_iddevice_id, err_cp, newScanToAverage)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_scans_to_average")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_scans_to_average(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         scanToAverage = self.oceandirectoceandirect.odapi_get_scans_to_average(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_scans_to_average")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def set_boxcar_width(self, newBoxcarWidth: int) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_set_boxcar_width(self.device_iddevice_id, err_cp, newBoxcarWidth)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_boxcar_width")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_boxcar_width(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         boxcarWidth = self.oceandirectoceandirect.odapi_get_boxcar_width(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_boxcar_width")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_max_intensity(self) -> int:
         ...
         self.oceandirectoceandirect.odapi_get_maximum_intensity.restype = c_double
         err_cp        = (c_long * 1)(0)
         max_intensity = self.oceandirectoceandirect.odapi_get_maximum_intensity(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "max_intensity")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_formatted_spectrum_length(self) -> int:
         ...
         return self.pixel_count_formattedpixel_count_formatted
     ...
     def get_wavelengths(self) -> list[float]:
         ...
         if self.wavelengthswavelengths is None:
             wl_c   = (c_double * self.pixel_count_formattedpixel_count_formatted)()
             err_cp = (c_long * 1)(0)
             buffer_size = self.oceandirectoceandirect.odapi_get_wavelengths(self.device_iddevice_id, err_cp, wl_c, self.pixel_count_formattedpixel_count_formatted)
             #logger.info("Buffer size returned: %d  expected %d " % (buffer_size, self.pixel_count_formatted))
             if err_cp[0] != 0:
                 error_msg = self.decode_errordecode_error(err_cp[0],"get_wavelengths")
                 raise OceanDirectError(err_cp[0], error_msg)
             else:
                 self.wavelengthswavelengths = list(wl_c)
         return self.wavelengthswavelengths
     ...
     def get_minimum_integration_time(self) -> int:
         ...
         err_cp       = (c_long * 1)(0)
         int_time_min = self.oceandirectoceandirect.odapi_get_minimum_integration_time_micros(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_minimum_integration_time")
             raise OceanDirectError(err_cp[0], error_msg)
         self.integration_minintegration_min = int_time_min
         return self.integration_minintegration_min
     ...
     def get_maximum_integration_time(self) -> int:
         ...
         err_cp       = (c_long * 1)(0)
         int_time_max = self.oceandirectoceandirect.odapi_get_maximum_integration_time_micros(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_maximum_integration_time")
             raise OceanDirectError(err_cp[0], error_msg)
         self.integration_maxintegration_max = int_time_max
         return self.integration_maxintegration_max
     ...
     def get_minimum_averaging_integration_time(self) -> int:
         ...
         err_cp       = (c_long * 1)(0)
         int_time_min = self.oceandirectoceandirect.odapi_get_minimum_averaging_integration_time_micros(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_minimum_averaging_integration_time")
             raise OceanDirectError(err_cp[0], error_msg)
         return int_time_min
     ...
     def set_integration_time(self, int_time: int) -> None:
         ...
         self.integration_timeintegration_time = int_time
         err_cp    = (c_long * 1)(0)
         error_msg = self.oceandirectoceandirect.odapi_set_integration_time_micros(self.device_iddevice_id, err_cp, c_ulong(int_time))
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"set_integration_time")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_integration_time(self) -> int:
         ...
         err_cp   = (c_long * 1)(0)
         int_time = self.oceandirectoceandirect.odapi_get_integration_time_micros(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_integration_time")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_integration_time_increment(self) -> int:
         ...
         err_cp   = (c_long * 1)(0)
         int_time = self.oceandirectoceandirect.odapi_get_integration_time_increment_micros(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_integration_time_increment")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def set_trigger_mode(self, mode: int) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_adv_set_trigger_mode(self.device_iddevice_id, err_cp, mode)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_trigger_mode")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_trigger_mode(self) -> None:
         ...
         err_cp  = (c_long * 1)(0)
         trigger = self.oceandirectoceandirect.odapi_adv_get_trigger_mode(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_trigger_mode")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_index_at_wavelength(self, wavelength: float) -> tuple[int, float]:
         ...
         new_wl = (c_double * 1)(0)
         err_cp = (c_long * 1)(0)
         index  = self.oceandirectoceandirect.odapi_get_index_at_wavelength(self.device_iddevice_id, err_cp, new_wl, c_double(wavelength))
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_index_at_wavelength")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_indices_at_wavelengths(self, wavelengths: list[float]) -> tuple[list[int], list[float]]:
         ...
         """
         wavelengthCount = len(self.get_wavelengthsget_wavelengths())
         length       = len(wavelengths)
         c_indices    = (c_int * wavelengthCount)()
         c_wavelength = (c_double * wavelengthCount)(*wavelengths)
         
         err_cp       = (c_long * 1)(0)
         indexCount   = self.oceandirectoceandirect.odapi_get_indices_at_wavelengths(self.device_iddevice_id, err_cp, c_indices, length, c_wavelength, length)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_indices_at_wavelengths")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_indices_at_wavelength_range(self, lo: float, hi: float, length: int) -> tuple[list[int], list[float]]:
         ...
         err_cp       = (c_long * 1)(0)
         wavelengthFoundCount = self.oceandirectoceandirect.odapi_get_indices_at_wavelength_range(self.device_iddevice_id, err_cp, c_indices, wavelengthCount,
                                                                                       c_wavelength, wavelengthCount, c_double(lo), c_double(hi))
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_indices_at_wavelength_range")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_number_electric_dark_pixels(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         self.num_electric_dark_pixelsnum_electric_dark_pixels = self.oceandirectoceandirect.odapi_get_electric_dark_pixel_count(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"get_number_electric_dark_pixels")
             raise OceanDirectError(err_cp[0], error_msg)
  
         return self.num_electric_dark_pixelsnum_electric_dark_pixels
     ...
     def get_electric_dark_pixel_indices(self) -> list[int]:
         ...
         if self.num_electric_dark_pixelsnum_electric_dark_pixels is None:
             self.get_number_electric_dark_pixelsget_number_electric_dark_pixels()
         ed_idx_c = (c_int * self.num_electric_dark_pixelsnum_electric_dark_pixels)()
         err_cp   = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_get_electric_dark_pixel_indices(self.device_iddevice_id, err_cp, ed_idx_c, self.num_electric_dark_pixelsnum_electric_dark_pixels)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"electric_dark_pixel_count")
             raise OceanDirectError(err_cp[0], error_msg)
         self.electric_dark_pixelselectric_dark_pixels = list(ed_idx_c)
  
         return self.electric_dark_pixelselectric_dark_pixels
     ...
     def details(self) -> None:
         ...
         logger.info("Device ID    : %d    status %s" % (self.device_iddevice_id, self.statusstatus))
         logger.info("Serial Number: %s" % self.get_serial_numberget_serial_number())
         logger.info("Model        : %s" % self.get_modelget_model())
         logger.info("Number pixels: %d" % self.pixel_count_formattedpixel_count_formatted)
     ...
     def is_feature_id_enabled(self, featureID: FeatureID) -> bool:
         ...
         """
         err_cp = (c_long * 1)(0)
         feature_supported =self.oceandirectoceandirect.odapi_is_feature_enabled(self.device_iddevice_id, err_cp, featureID.value)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "is_feature_id_enabled")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def set_acquisition_delay(self, delayMicrosecond: int) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_set_acquisition_delay_microseconds(self.device_iddevice_id, err_cp, c_ulong(delayMicrosecond))
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_acquisition_delay_microseconds")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_acquisition_delay(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         delay_microsecond = self.oceandirectoceandirect.odapi_get_acquisition_delay_microseconds(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_acquisition_delay_microseconds")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_acquisition_delay_increment(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         delay_increment_microsecond = self.oceandirectoceandirect.odapi_get_acquisition_delay_increment_microseconds(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_acquisition_delay_increment_microseconds")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_acquisition_delay_maximum(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         delay_maximum_microsecond = self.oceandirectoceandirect.odapi_get_acquisition_delay_maximum_microseconds(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_acquisition_delay_maximum_microseconds")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_acquisition_delay_minimum(self) -> int:
         ...
         err_cp = (c_long * 1)(0)
         delay_minimum_microsecond = self.oceandirectoceandirect.odapi_get_acquisition_delay_minimum_microseconds(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_acquisition_delay_minimum_microseconds")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def set_stored_dark_spectrum(self, darkSpectrum: list[float]) -> None:
         ...
         if len(darkSpectrum) == 0:
             ...
             error_msg = self.decode_errordecode_error(10,"set_stored_dark_spectrum")
         ...
         self.oceandirectoceandirect.odapi_set_stored_dark_spectrum(self.device_iddevice_id, err_cp, double_array, double_array_count)
  
         if err_cp[0] != 0:
            error_msg = self.decode_errordecode_error(err_cp[0],"set_stored_dark_spectrum")
            raise OceanDirectError(err_cp[0], error_msg)
     ...
     def nonlinearity_correct_spectrum1(self, illuminatedSpectrum: list[float]) -> list[float]:
         ...
         if len(illuminatedSpectrum) == 0:
             #code 10 means missing value
             error_msg = self.decode_errordecode_error(10,"nonlinearity_correct_spectrum1")
             raise OceanDirectError(10, error_msg)
         ...
         self.oceandirectoceandirect.odapi_nonlinearity_correct_spectrum1(self.device_iddevice_id, err_cp, illuminated_spectrum_array, illuminated_spectrum_array_count,
                                                               corrected_spectrum_array, self.pixel_count_formattedpixel_count_formatted)
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"nonlinearity_correct_spectrum1")
             raise OceanDirectError(err_cp[0], error_msg)
         return list(corrected_spectrum_array)
     ...
     def nonlinearity_correct_spectrum2(self, darkSpectrum: list[float], illuminatedSpectrum: list[float]) -> list[float]:
         ...
         if len(darkSpectrum) == 0 or len(illuminatedSpectrum) == 0:
             #code 10 means missing value
             error_msg = self.decode_errordecode_error(10,"nonlinearity_correct_spectrum2")
             raise OceanDirectError(10, error_msg)
         ...
         self.oceandirectoceandirect.odapi_nonlinearity_correct_spectrum2(self.device_iddevice_id, err_cp, dark_spectrum_array, dark_spectrum_array_count,
                                                               illuminated_spectrum_array, illuminated_spectrum_array_count,
                                                               corrected_spectrum_array, self.pixel_count_formattedpixel_count_formatted)
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0],"nonlinearity_correct_spectrum2")
             raise OceanDirectError(err_cp[0], error_msg)
         return list(corrected_spectrum_array)
     ...
     def set_electric_dark_correction_usage(self, isEnabled: bool) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_apply_electric_dark_correction_usage(self.device_iddevice_id, err_cp, isEnabled)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_electric_dark_correction_usage")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_electric_dark_correction_usage(self) -> bool:
         ...
         err_cp = (c_long * 1)(0)
         correctionState = self.oceandirectoceandirect.odapi_get_electric_dark_correction_usage(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_electric_dark_correction_usage")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def set_nonlinearity_correction_usage(self, isEnabled: bool) -> None:
         ...
         err_cp = (c_long * 1)(0)
         self.oceandirectoceandirect.odapi_apply_nonlinearity_correct_usage(self.device_iddevice_id, err_cp, isEnabled)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "set_nonlinearity_correction_usage")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     def get_nonlinearity_correction_usage(self) -> bool:
         ...
         err_cp = (c_long * 1)(0)
         correctionState = self.oceandirectoceandirect.odapi_get_nonlinearity_correct_usage(self.device_iddevice_id, err_cp)
  
         if err_cp[0] != 0:
             error_msg = self.decode_errordecode_error(err_cp[0], "get_nonlinearity_correction_usage")
             raise OceanDirectError(err_cp[0], error_msg)
     ...
     class Advanced():
         ...
         def __init__(self, device: 'Spectrometer'):
             ...
             self._temperature_count_temperature_count = None
         ...
         def set_enable_lamp(self, enable: bool) -> None:
             ...
             if enable :
                 self.devicedevice.oceandirect.odapi_adv_set_lamp_enable(self.devicedevice.device_id, err_cp, self.lamp_onlamp_on)
             else:
                 self.devicedevice.oceandirect.odapi_adv_set_lamp_enable(self.devicedevice.device_id, err_cp, self.lamp_offlamp_off)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"enable_lamp")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_enable_lamp(self) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_get_lamp_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_enable_lamp")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_shutter_open(self, shutterState: bool) -> None:
             ...
             """
             err_cp = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_set_shutter_open(self.devicedevice.device_id, err_cp, c_ubyte(shutterState))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"set_shutter_open")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_shutter_state(self) -> None:
             ...
             """
             err_cp = (c_long * 1)(0)
             shutterState = self.devicedevice.oceandirect.odapi_adv_get_shutter_state(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_shutter_state")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_wavelength_coeffs(self) -> list[float]:
             ...
             wl_c = (c_double * 20)()
             err_cp = (c_long * 1)(0)
             buffer_size = self.devicedevice.oceandirect.odapi_get_wavelength_coeffs(self.devicedevice.device_id, err_cp, wl_c, 20)
  
             logger.info("Buffer size returned: %d  " % (buffer_size))
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_wavelength_coeffs")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_nonlinearity_coeffs(self) -> list[float]:
             ...
             num_coeffs = self.num_nonlinearity_coeffsnum_nonlinearity_coeffs
             nl_coeff   = (c_double * num_coeffs)(0)
             err_cp     = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_nonlinearity_coeffs(self.devicedevice.device_id, err_cp, nl_coeff, num_coeffs)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_nonlinearity_coeffs")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_nonlinearity_coeffs_count1(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             nl_count = self.devicedevice.oceandirect.odapi_adv_get_nonlinearity_coeffs_count1(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_nonlinearity_coeffs_count1")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_nonlinearity_coeffs1(self, index: int) -> float:
             ...
             self.devicedevice.oceandirect.odapi_adv_get_nonlinearity_coeffs1.restype = c_double
  
             err_cp = (c_long * 1)(0)
             nl_coefficient = self.devicedevice.oceandirect.odapi_adv_get_nonlinearity_coeffs1(self.devicedevice.device_id, err_cp, c_int(index))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_nonlinearity_coeffs1")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_tec_temperature_degrees_C(self) -> float:
             ...
             self.devicedevice.oceandirect.odapi_adv_tec_get_temperature_degrees_C.restype = c_double
             err_cp = (c_long * 1)(0)
             temp   = self.devicedevice.oceandirect.odapi_adv_tec_get_temperature_degrees_C(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_tec_temperature_degrees_C")
                 raise OceanDirectError(err_cp[0], error_msg)
             return temp
         ...
         def set_temperature_setpoint_degrees_C(self, temp_C: float) -> None:
             ...
             err_cp = (c_long * 1)(0)
             temp   = self.devicedevice.oceandirect.odapi_adv_tec_set_temperature_setpoint_degrees_C(self.devicedevice.device_id, err_cp, c_double(temp_C))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"set_tec_setpoint")
                 raise OceanDirectError(err_cp[0], error_msg)
             #return temp
         ...
         def set_tec_enable(self, coolerEnable: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_tec_set_enable(self.devicedevice.device_id, err_cp, c_ubyte(coolerEnable))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_tec_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_tec_enable(self) -> bool:
             ...
             err_cp  = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_tec_get_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_tec_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(c_ubyte(enabled))
         ...
         def get_temperature_setpoint_degrees_C(self) -> float:
             ...
             self.devicedevice.oceandirect.odapi_adv_tec_get_temperature_setpoint_degrees_C.restype = c_float
             err_cp = (c_long * 1)(0)
             temp   = self.devicedevice.oceandirect.odapi_adv_tec_get_temperature_setpoint_degrees_C(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_tec_setpoint")
                 raise OceanDirectError(err_cp[0], error_msg)
             return temp
         ...
         def get_tec_stable(self) -> bool:
             ...
             err_cp  = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_tec_get_stable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_tec_stable")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(c_ubyte(enabled))
         ...
         def get_tec_fan_enable(self) -> bool:
             ...
             err_cp  = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_tec_get_fan_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_tec_fan_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(c_ubyte(enabled))
         ...
         def get_light_source_count(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             light_source_count = self.devicedevice.oceandirect.odapi_adv_get_light_source_count(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_light_source_count")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def has_light_source_enable(self, light_source_index: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             status = self.devicedevice.oceandirect.odapi_adv_light_source_has_enable(self.devicedevice.device_id, err_cp, light_source_index)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "has_light_source_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(status)
         ...
         def is_light_source_enabled(self, light_source_index: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             status = self.devicedevice.oceandirect.odapi_adv_light_source_is_enabled(self.devicedevice.device_id, err_cp, light_source_index)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "is_light_source_enabled")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(status)
         ...
         def enable_light_source(self, light_source_index: int, enable: bool) -> None:
             ...
             if enable :
                 self.devicedevice.oceandirect.odapi_adv_light_source_set_enable(self.devicedevice.device_id,  err_cp, light_source_index, self.lamp_onlamp_on)
             else:
                 self.devicedevice.oceandirect.odapi_adv_light_source_set_enable(self.devicedevice.device_id, err_cp, light_source_index, self.lamp_offlamp_off)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "enable_light_source")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_single_strobe_enable(self, enable: bool) -> None:
             ...
             if enable :
                 self.devicedevice.oceandirect.odapi_adv_set_single_strobe_enable(self.devicedevice.device_id, err_cp, self.lamp_onlamp_on)
             else:
                 self.devicedevice.oceandirect.odapi_adv_set_single_strobe_enable(self.devicedevice.device_id, err_cp, self.lamp_offlamp_off)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_single_strobe_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_single_strobe_delay(self, delayMicrosecond: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_single_strobe_delay(self.devicedevice.device_id, err_cp, c_ulong(delayMicrosecond))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_single_strobe_delay")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_single_strobe_width(self, widthMicrosecond: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_single_strobe_width(self.devicedevice.device_id, err_cp, c_ulong(widthMicrosecond))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_single_strobe_width")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_enable(self) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             enable = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "is_single_strobe_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_delay(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             delay_microsecond = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_delay(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_delay")
                 raise OceanDirectError(err_cp[0], error_msg)
             return delay_microsecond
         ...
         def get_single_strobe_width(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             width_microsecond = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_width(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_width")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_delay_minimum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             minimum_microseconds = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_delay_minimum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_delay_minimum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_delay_maximum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             maximum_microseconds = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_delay_maximum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_delay_maximum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_delay_increment(self) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             delay_increment = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_delay_increment(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_delay_increment")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_width_minimum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             width_minimum = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_width_minimum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_width_minimum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_width_maximum(self) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             width_maximum = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_width_maximum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_width_maximum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_width_increment(self) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             width_increment = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_width_increment(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_width_increment")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_single_strobe_cycle_maximum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             cyle_maximum = self.devicedevice.oceandirect.odapi_adv_get_single_strobe_cycle_maximum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_single_strobe_cycle_maximum")
                 raise OceanDirectError(err_cp[0], error_msg)
             return cyle_maximum
         ...
         def set_continuous_strobe_period(self, period: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_continuous_strobe_period_micros(self.devicedevice.device_id, err_cp, period)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_continuous_strobe_period_micros")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_continuous_strobe_enable(self, enable: bool) -> None:
             ...
             if enable :
                 self.devicedevice.oceandirect.odapi_adv_set_continuous_strobe_enable(self.devicedevice.device_id, err_cp, self.lamp_onlamp_on)
             else:
                 self.devicedevice.oceandirect.odapi_adv_set_continuous_strobe_enable(self.devicedevice.device_id, err_cp, self.lamp_offlamp_off)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_continuous_strobe_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_continuous_strobe_period(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             period_microsecond = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_period_micros(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_continuous_strobe_period")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_continuous_strobe_enable(self) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             enable = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "is_continuous_strobe_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(c_ubyte(enable))
         ...
         def get_continuous_strobe_period_minimum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             minimum_microsecond = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_period_minimum_micros(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_continuous_strobe_period_minimum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_continuous_strobe_period_maximum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             maximum_microsecond = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_period_maximum_micros(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_continuous_strobe_period_maximum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_continuous_strobe_period_increment(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             increment_microsecond = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_period_increment_micros(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_continuous_strobe_period_increment")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_continuous_strobe_width(self) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             width_microsecond = self.devicedevice.oceandirect.odapi_adv_get_continuous_strobe_width_micros(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_continuous_strobe_width")
                 raise OceanDirectError(err_cp[0], error_msg)
             return width_microsecond
         ...
         def set_continuous_strobe_width(self, widthMicrosecond: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_continuous_strobe_width_micros(self.devicedevice.device_id, err_cp, c_ulong(widthMicrosecond))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_continuous_strobe_width")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def clear_data_buffer(self) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_clear_data_buffer(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "clear_data_buffer")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_data_buffer_number_of_elements(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             number_of_elements = self.devicedevice.oceandirect.odapi_adv_get_data_buffer_number_of_elements(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_data_buffer_number_of_elements")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_data_buffer_capacity(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             maximum_buffer = self.devicedevice.oceandirect.odapi_adv_get_data_buffer_capacity(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_data_buffer_capacity")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_data_buffer_capacity_maximum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             maximum_buffer_capacity = self.devicedevice.oceandirect.odapi_adv_get_data_buffer_capacity_maximum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_data_buffer_capacity_maximum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_data_buffer_capacity_minimum(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             minimum_buffer_capacity = self.devicedevice.oceandirect.odapi_adv_get_data_buffer_capacity_minimum(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_data_buffer_capacity_minimum")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_data_buffer_capacity(self, capacity: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_data_buffer_capacity(self.devicedevice.device_id, err_cp, capacity)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_data_buffer_capacity")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_data_buffer_enable(self, enable: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_data_buffer_enable(self.devicedevice.device_id, err_cp, flag)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_data_buffer_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_data_buffer_enable(self) -> bool:
             ...
             err_cp          = (c_long * 1)(0)
             dataBufferState = self.devicedevice.oceandirect.odapi_adv_get_data_buffer_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_data_buffer_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def abort_acquisition(self) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_abort_acquisition(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "abort_acquisition")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def acquire_spectra_to_buffer(self) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_acquire_spectra_to_buffer(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "acquire_spectra_to_buffer")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_idle_state(self) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             retval = self.devicedevice.oceandirect.odapi_adv_get_device_idle_state(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_idle_state")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_number_of_backtoback_scans(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             retval = self.devicedevice.oceandirect.odapi_adv_get_number_of_backtoback_scans(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_number_of_backtoback_scans")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_number_of_backtoback_scans(self, numScans: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_number_of_backtoback_scans(self.devicedevice.device_id, err_cp, numScans)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_number_of_backtoback_scans")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_raw_spectrum_with_metadata(self, list_raw_spectra: list[list[float]], list_timestamp: list[int], buffer_size: int) -> int:
             ...
             for x in range(buffer_size):
                 buffer[x] = (c_double * self.devicedevice.pixel_count_formatted)()
  
             timestamp    = (c_longlong * buffer_size)(0)
             err_cp       = (c_long * 1)(0)
             spectraCount = self.devicedevice.oceandirect.odapi_get_raw_spectrum_with_metadata(self.devicedevice.device_id, err_cp, buffer, buffer_size,
                                                                                         self.devicedevice.pixel_count_formatted, timestamp, buffer_size)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_raw_spectrum_with_metadata")
                 raise OceanDirectError(err_cp[0], error_msg)
  
             for x in range(spectraCount):
                 spectra = [None] * self.devicedevice.pixel_count_formatted
  
                 #Convert c-types into python. There might be a better way to do this.
                 for y in range(self.devicedevice.pixel_count_formatted):
         ...
         def get_usb_endpoint_primary_out(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             usb_primary_endpoint_out = self.devicedevice.oceandirect.odapi_get_device_usb_endpoint_primary_out(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_usb_endpoint_primary_out")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_usb_endpoint_primary_in(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             usb_primary_endpoint_in = self.devicedevice.oceandirect.odapi_get_device_usb_endpoint_primary_in(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_usb_endpoint_primary_in")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_usb_endpoint_secondary_out(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             usb_secondary_endpoint_out = self.devicedevice.oceandirect.odapi_get_device_usb_endpoint_secondary_out(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_usb_endpoint_secondary_out")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_usb_endpoint_secondary_in(self) -> int:
             ...
             usb_secondary_endpoint_in = self.devicedevice.oceandirect.odapi_get_device_usb_endpoint_secondary_in(self.devicedevice.device_id, err_cp)
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_usb_endpoint_secondary_in")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_revision_firmware(self) -> str:
             ...
             bytesRead      = self.devicedevice.oceandirect.odapi_adv_get_revision_firmware(self.devicedevice.device_id, err_cp, fw_revision_cp, 100)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_revision_firmware")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_revision_fpga(self) -> str:
             ...
             bytesRead      = self.devicedevice.oceandirect.odapi_adv_get_revision_fpga(self.devicedevice.device_id, err_cp, fpga_revision_cp, 100)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_revision_fpga")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def ipv4_is_dhcp_enabled(self, ifNum: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             enable = self.devicedevice.oceandirect.odapi_adv_ipv4_is_dhcp_enabled(self.devicedevice.device_id, err_cp, c_ubyte(ifNum))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_is_dhcp_enabled")
                 raise OceanDirectError(err_cp[0], error_msg)
             return bool(c_ubyte(enable))
         ...
         def ipv4_set_dhcp_enable(self, ifNum: int, enabled: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_ipv4_set_dhcp_enable(self.devicedevice.device_id, err_cp, ifNum, enabled)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_set_dhcp_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def ipv4_get_number_of_ip_addresses(self, ifNum: int) -> int:
             ...
             err_cp       = (c_long * 1)(0)
             numIpAddress = self.devicedevice.oceandirect.odapi_adv_ipv4_get_number_of_ip_addresses(self.devicedevice.device_id, err_cp, ifNum)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_get_number_of_ip_addresses")
                 raise OceanDirectError(err_cp[0], error_msg)
             return numIpAddress;
         ...
         def ipv4_read_ip_address(self, ifNum: int, addressIndex: int) -> tuple[list[int], int]:
             ...
             self.devicedevice.oceandirect.odapi_adv_ipv4_read_ip_address(self.devicedevice.device_id, err_cp, c_ubyte(ifNum), c_ubyte(addressIndex),
         ...
         def ipv4_add_static_ip_address(self, ifNum: int, ipAddress: list[int], netmask: int) -> None:
             ...
             self.devicedevice.oceandirect.odapi_adv_ipv4_add_static_ip_address(self.devicedevice.device_id, err_cp, c_ubyte(ifNum), ip_address_cp, 4, c_uint(netmask))
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_add_static_ip_address")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def ipv4_delete_static_ip_address(self, ifNum: int, addressIndex: int) -> None:
             ...
             self.devicedevice.oceandirect.odapi_adv_ipv4_delete_static_ip_address(self.devicedevice.device_id, err_cp, c_ubyte(ifNum), c_ubyte(addressIndex))
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_delete_static_ip_address")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def ipv4_set_default_gateway_ip_address(self, ifNum: int, ipAddress: list[int]) -> None:
             ...
             self.devicedevice.oceandirect.odapi_adv_ipv4_set_default_gateway_ip_address(self.devicedevice.device_id, err_cp, c_ubyte(ifNum), ip_address_cp, 4)
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_set_default_gateway_ip_address")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def ipv4_get_default_gateway_ip_address(self, ifNum: int) -> list[int]:
             ...
             err_cp        = (c_long * 1)(0)
             ip_address_cp = (c_ubyte * 4)(0)
             self.devicedevice.oceandirect.odapi_adv_ipv4_get_default_gateway_ip_address(self.devicedevice.device_id, err_cp, c_ubyte(ifNum),
                                                                                   ip_address_cp, 4)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "ipv4_get_default_gateway_ip_address")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_gpio_pin_count(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             gpioPinCount = self.devicedevice.oceandirect.odapi_adv_get_gpio_pin_count(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_gpio_pin_count")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_output_enable1(self, bit: int, isOutput: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_output_enable1(self.devicedevice.device_id, err_cp, bit, isOutput)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_output_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_output_enable1(self, bit: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             bitDirection = self.devicedevice.oceandirect.odapi_adv_gpio_get_output_enable1(self.devicedevice.device_id, err_cp, bit)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_output_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_output_enable2(self, bitmask: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_output_enable2(self.devicedevice.device_id, err_cp, c_int(bitmask))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_output_enable2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_output_enable2(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             allBitDirection = self.devicedevice.oceandirect.odapi_adv_gpio_get_output_enable2(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_output_enable2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_value1(self, bit: int, isHigh: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_value1(self.devicedevice.device_id, err_cp, bit, isHigh)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_value")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_value1(self, bit: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             bitValue = self.devicedevice.oceandirect.odapi_adv_gpio_get_value1(self.devicedevice.device_id, err_cp, bit)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_value")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_value2(self, bitmask: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_value2(self.devicedevice.device_id, err_cp, c_int(bitmask))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_value2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_value2(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             allBitValue = self.devicedevice.oceandirect.odapi_adv_gpio_get_value2(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_value2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_output_alternate1(self, bit: int, isAlternate: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_output_alternate1(self.devicedevice.device_id, err_cp, bit, isAlternate)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_output_alternate1")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_set_output_alternate2(self, bitmask: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_gpio_set_output_alternate2(self.devicedevice.device_id, err_cp, c_int(bitmask))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_set_output_alternate2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_output_alternate1(self, bit: int) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             bitValue = self.devicedevice.oceandirect.odapi_adv_gpio_get_output_alternate1(self.devicedevice.device_id, err_cp, bit)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_output_alternate1")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def gpio_get_output_alternate2(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             allBitValue = self.devicedevice.oceandirect.odapi_adv_gpio_get_output_alternate2(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "gpio_get_output_alternate2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_led_enable(self, isEnabled: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_led_enable(self.devicedevice.device_id, err_cp, isEnabled)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_led_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_led_enable(self) -> bool:
             ...
             err_cp = (c_long * 1)(0)
             ledState = self.devicedevice.oceandirect.odapi_adv_get_led_enable(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_led_enable")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_original_vid(self) -> int:
             ...
             err_cp   = (c_long * 1)(0)
             orig_vid = self.devicedevice.oceandirect.odapi_adv_get_device_original_vid(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_original_vid")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_original_pid(self) -> int:
             ...
             err_cp   = (c_long * 1)(0)
             orig_pid = self.devicedevice.oceandirect.odapi_adv_get_device_original_pid(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_original_pid")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_vid(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             vid    = self.devicedevice.oceandirect.odapi_adv_get_device_vid(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_vid")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_pid(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             pid    = self.devicedevice.oceandirect.odapi_adv_get_device_pid(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_pid")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_original_manufacturer_string(self) -> str:
             ...
             err_cp            = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_device_original_manufacturer_string(self.devicedevice.device_id, err_cp, orig_manufacturer, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_original_manufacturer_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_original_model_string(self) -> str:
             ...
             err_cp     = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_device_original_model_string(self.devicedevice.device_id, err_cp, orig_model, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_original_model_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_manufacturer_string(self) -> str:
             ...
             err_cp       = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_device_manufacturer_string(self.devicedevice.device_id, err_cp, manufacturer, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_manufacturer_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_model_string(self) -> str:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_device_model_string(self.devicedevice.device_id, err_cp, model, 50)
         ...
         def set_device_manufacturer_string(self, manufacturer: str) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_device_manufacturer_string(self.devicedevice.device_id, err_cp, manufacturer.encode('utf-8'), len(manufacturer))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_device_manufacturer_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_device_model_string(self, model: str) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_device_model_string(self.devicedevice.device_id, err_cp, model.encode('utf-8'), len(model))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_device_model_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_device_alias(self) -> str:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_get_device_alias(self.devicedevice.device_id, err_cp, device_alias, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_device_alias")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_device_alias(self, deviceAlias: str) -> None:
             ...
             if not deviceAlias:
                 #15 is an error code defined in OceanDirectAPIConstants.c
                 error_msg = self.devicedevice.decode_error(15, "set_device_alias")
                 raise OceanDirectError(15, error_msg)
  
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_device_alias(self.devicedevice.device_id, err_cp, deviceAlias.encode('utf-8'), len(deviceAlias))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"set_device_alias")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def reset_device(self) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_reset_device(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"reset_device")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_user_string(self) -> str:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_get_user_string(self.devicedevice.device_id, err_cp, user_string, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_user_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_user_string(self, userString: str) -> None:
             ...
             if not userString:
                 #15 is an error code defined in OceanDirectAPIConstants.c
                 error_msg = self.devicedevice.decode_error(15, "set_user_string")
                 raise OceanDirectError(15, error_msg)
  
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_set_user_string(self.devicedevice.device_id, err_cp, userString.encode('utf-8'), len(userString))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"set_user_string")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_user_string_count2(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             string_count = self.devicedevice.oceandirect.odapi_get_user_string_count1(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_user_string_count")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_user_string2(self, index: int) -> str:
             ...
             user_string = create_string_buffer(b'\000'*50)
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_get_user_string1(self.devicedevice.device_id, err_cp, c_int(index), user_string, 50)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_user_string2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_user_string2(self, index: int, userString: str) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_set_user_string1(self.devicedevice.device_id, err_cp, c_int(index), userString.encode('utf-8'), len(userString))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"set_user_string2")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_autonull_maximum_adc_count(self) -> int:
             ...
             err_cp   = (c_long * 1)(0)
             adcCount = self.devicedevice.oceandirect.odapi_adv_get_autonull_maximum_adc_count(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_autonull_maximum_adc_count")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_autonull_baseline_level(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             baseline = self.devicedevice.oceandirect.odapi_adv_get_autonull_baseline_level(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_autonull_baseline_level")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_autonull_saturation_level(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             saturation = self.devicedevice.oceandirect.odapi_adv_get_autonull_saturation_level(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_autonull_saturation_level")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_baud_rate(self) -> int:
             ...
             err_cp = (c_long * 1)(0)
             baud_rate = self.devicedevice.oceandirect.odapi_adv_get_baud_rate(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_baud_rate")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_baud_rate(self, baudRate: int) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_set_baud_rate(self.devicedevice.device_id, err_cp, c_int(baudRate))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_baud_rate")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def save_settings_to_flash(self) -> None:
             ...
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_save_settings_to_flash(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "save_settings_to_flash")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_active_pixel_range(self) -> list[int]:
             ...
             range  = (c_int * 10)(0)
             err_cp = (c_long * 1)(0)
             elementCopied = self.devicedevice.oceandirect.odapi_get_active_pixel_range(self.devicedevice.device_id, err_cp, range, 10)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_active_pixel_range")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_optical_dark_pixel_range(self) -> list[int]:
             ...
             range  = (c_int * 10)(0)
             err_cp = (c_long * 1)(0)
             elementCopied = self.devicedevice.oceandirect.odapi_get_optical_dark_pixel_range(self.devicedevice.device_id, err_cp, range, 10)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_optical_dark_pixel_range")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_transition_pixel_range(self) -> list[int]:
             ...
             range  = (c_int * 10)(0)
             err_cp = (c_long * 1)(0)
             elementCopied = self.devicedevice.oceandirect.odapi_get_transition_pixel_range(self.devicedevice.device_id, err_cp, range, 10)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_transition_pixel_range")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_bad_pixel_indices(self) -> list[int]:
             ...
             range  = (c_int * 10)(0)
             err_cp = (c_long * 1)(0)
             elementCopied = self.devicedevice.oceandirect.odapi_get_bad_pixel_indices(self.devicedevice.device_id, err_cp, range, 10)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0],"get_bad_pixel_indices")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_network_interface_count(self) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             if_count = self.devicedevice.oceandirect.odapi_adv_network_conf_get_interface_count(self.devicedevice.device_id, err_cp)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_network_interface_count")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_network_interface_type(self, interfaceIndex: int) -> int:
             ...
             """
             err_cp = (c_long * 1)(0)
             if_type = self.devicedevice.oceandirect.odapi_adv_network_conf_get_interface_type(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_network_interface_type")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_network_interface_status(self, interfaceIndex: int) -> bool:
             ...
             """
             err_cp = (c_long * 1)(0)
             enabled = self.devicedevice.oceandirect.odapi_adv_network_conf_get_interface_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_network_interface_status")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_network_interface_status(self, interfaceIndex: int, enable: bool) -> None:
             ...
             if enable:
                 self.devicedevice.oceandirect.odapi_adv_network_conf_set_interface_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), c_ubyte(1))
             else:
                 self.devicedevice.oceandirect.odapi_adv_network_conf_set_interface_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), c_ubyte(0))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_network_interface_status")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def save_network_interface_setting(self, interfaceIndex: int) -> None:
             ...
             """
             err_cp = (c_long * 1)(0)
             self.devicedevice.oceandirect.odapi_adv_network_conf_save_interface_setting(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "save_network_interface_setting")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_ethernet_gigabit_enable_status(self, interfaceIndex: int) -> bool:
             ...
             """
             err_cp = (c_long * 1)(0)
             status = self.devicedevice.oceandirect.odapi_adv_ethernet_get_gigabit_enable_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex))
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_ethernet_gigabit_enable_status")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_ethernet_gigabit_enable_status(self, interfaceIndex: int, enable: bool) -> None:
             ...
             err_cp = (c_long * 1)(0)
             if enable:
                 self.devicedevice.oceandirect.odapi_adv_ethernet_set_gigabit_enable_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), 1)
             else:
                 self.devicedevice.oceandirect.odapi_adv_ethernet_set_gigabit_enable_status(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), 0)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_ethernet_gigabit_enable_status")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def get_ethernet_mac_address(self, interfaceIndex: int) -> list[int]:
             ...
             self.devicedevice.oceandirect.odapi_adv_ethernet_get_mac_address(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), mac_address_cp, array_len)
  
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "get_ethernet_mac_address")
                 raise OceanDirectError(err_cp[0], error_msg)
         ...
         def set_ethernet_mac_address(self, interfaceIndex: int, macAddress: list[int]) -> None:
             ...
             self.devicedevice.oceandirect.odapi_adv_ethernet_set_mac_address(self.devicedevice.device_id, err_cp, c_uint(interfaceIndex), mac_address_cp, array_len)
             if err_cp[0] != 0:
                 error_msg = self.devicedevice.decode_error(err_cp[0], "set_ethernet_mac_address")
                 raise OceanDirectError(err_cp[0], error_msg)
